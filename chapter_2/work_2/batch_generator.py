...
if __name__ == "__main__":
    ...
    # ✅ Carpeta donde guardar el archivo CSV (junto a este script)
    base_dir = os.path.dirname(__file__)  # Ruta absoluta del script
    output_dir = os.path.join(base_dir, "data_2")
    os.makedirs(output_dir, exist_ok=True)

    # ✅ Nombre del archivo de salida
    output_file = os.path.join(output_dir, f"batch_{date.today()}.csv")
